    ...
    <div className="admin-dashboard-container">
      <aside className="admin-sidebar">
        ...
        <nav className={isMobileMenuOpen ? 'open' : ''}>
          ...
          <NavLink to="/admin/categories" className={({ isActive }) => isActive ? "admin-nav-link active" : "admin-nav-link"} onClick={() => setMobileMenuOpen(false)}>{t('admin_nav_categories', 'Categorías')}</NavLink>
